...
<header class="header">
   ...
   <section class="flex">
      ...
      <!-- Icônes pour le menu, la recherche, l'utilisateur et le thème -->
      <div class="icons">
      ...
      <div class="profile">
         <?php
         // Sélection du profil de l'utilisateur actuel
...
<div class="side-bar">
   ...
   <!-- Profil de l'utilisateur dans la barre latérale -->
   <div class="profile">
         <?php
            $select_profile = $conn->prepare("SELECT * FROM `tutors` WHERE id = ?");
            $select_profile->execute([$tutor_id]);
   ...
   <nav class="navbar">
      ...
      <a href="contents.php"><i class="fas fa-graduation-cap"></i><span>courses</span></a>
