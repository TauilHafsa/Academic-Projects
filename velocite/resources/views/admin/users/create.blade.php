                ...
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            ...
                            <p class="text-gray-600">Add a new user to the Vélocité platform</p>
                        </div>
                        <div>
                                        ...
                                        <div class="flex">
                                            ...
                                            <div class="ml-3">
                                                ...
                                                <div class="mt-2 text-sm text-yellow-700">
                                                    <p>When creating agent or admin accounts, make sure to provide complete profile information including city for proper access control.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
