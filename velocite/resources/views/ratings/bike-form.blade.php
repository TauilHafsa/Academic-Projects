<x-app-layout>
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900">Rate Your Bike Experience</h1>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <form action="{{ route('rentals.rate.bike', $rental->id) }}" method="POST">
                    @csrf
                    <div class="space-y-6">
                        <div>
                            <h3 class="text-lg font-medium text-gray-900">Rate Your Experience</h3>
                            <p class="mt-1 text-sm text-gray-500">
                                Please provide a rating based on your experience with this bike rental.
                            </p>
                        </div>
